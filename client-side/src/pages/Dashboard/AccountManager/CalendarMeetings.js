...
import { 
  ...
  MessageSquare, Video, Edit, Plus, 
  ArrowRight, MapPin, 
  Zap, ArrowUpDown,ArrowLeft
} from 'lucide-react';
        ...
        {/* Calendar & Meetings Tab */}
          <div className="space-y-6">
            ...
            <div className="bg-white bg-opacity-0 dark:bg-gray-800 dark:bg-opacity-0 rounded-lg shadow-sm mb-6">
              <div className="pt-6 border-gray-200 dark:border-gray-700">
                <div className="flex justify-between items-center">
                  <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 md:mb-6 text-gray-800 dark:text-white">Upcoming Meetings</h3>
                  <button
                ...
                <div className="space-y-4">
                  {accountManagerData.upcomingMeetings.map(meeting => (
                    <div key={meeting.id} className="p-4 md:p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-md border border-gray-200 dark:border-gray-700">
...
<div className="md:p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-md border border-gray-200 dark:border-gray-700 p-6">
