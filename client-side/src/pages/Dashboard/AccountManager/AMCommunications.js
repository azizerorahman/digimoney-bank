          ...
          <div className="bg-white bg-opacity-0 dark:bg-gray-800 dark:bg-opacity-0 rounded-lg shadow-sm mb-6">
            <div className="pt-6 border-gray-200 dark:border-gray-700">
              <div className="flex justify-between items-center">
                <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 md:mb-6 text-gray-800 dark:text-white">
                  Communication History
                </h3>
              ...
              <div className="space-y-4">
                {accountManagerData.communicationHistory.map((comm) => (
                  <div
                    key={comm.id}
                    className="p-4 md:p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-md border border-gray-200 dark:border-gray-700"
                  >
...
export default AMCommunications;
