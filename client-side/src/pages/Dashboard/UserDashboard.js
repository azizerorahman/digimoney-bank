                                    ...
                                    >
                                        ...
                                        <div className="relative z-10">
                                            <div className="flex items-center justify-between mb-3 md:mb-4">
                                                ...
                                                <div
                                                    className={`w-3 h-3 rounded-full ${account.isActive ? "bg-green-400" : "bg-red-400"
                                                        }`}
                                                />
                                            </div>
                                    ...
                                    {currentUser.accounts.map((account) => (
                                        ...
                                        >
                                            <div className="flex items-center space-x-3">
                                                <div
                                                    className={`w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center text-white font-bold text-xs md:text-sm ${account.type === "Checking"
                                                        ? "bg-blue-500"
                                            ...
                                            <div
                                                className={`font-bold text-xs md:text-sm ${account.balance < 0
                                                    ? "text-red-500"
                                ...
                                <div className="space-y-3 md:space-y-4">
                                    {getAccountTransactions(selectedAccount.id).map((transaction) => (
                                        ...
                                        >
                                            ...
                                            <div
                                                className={`font-bold text-xs md:text-sm ${transaction.amount < 0 ? "text-red-500" : "text-green-500"
                                                    }`}
                                            >
                        ...
                        <div className="bg-white shadow-2xl rounded-2xl p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3
                                        className={`text-2xl font-bold ${currentUser.investmentPortfolio.totalGainLoss >= 0
                                            ? "text-green-600"
                                            : "text-red-600"
                                            }`}
                                    >
                                    ...
                                    <p
                                        className={`text-sm ${currentUser.investmentPortfolio.totalGainLoss >= 0
                                            ? "text-green-600"
                                            : "text-red-600"
                                            }`}
                                    >
                                ...
                                <div
                                    className={`w-12 h-12 rounded-full flex items-center justify-center ${currentUser.investmentPortfolio.totalGainLoss >= 0
                                        ? "bg-green-100"
                                        : "bg-red-100"
                                        }`}
                                >
                                    <svg
                                        className={`w-6 h-6 ${currentUser.investmentPortfolio.totalGainLoss >= 0
                                            ? "text-green-600"
                                            : "text-red-600"
                                            }`}
                                        fill="none"
                            ...
                            {(currentUser.creditHistory?.alerts || []).map((alert, index) => (
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        <div
                                            className={`w-6 h-6 rounded-full flex items-center justify-center ${alert.type === "warning"
                                                ? "bg-yellow-400"
                                                : alert.type === "success"
                                                    ? "bg-green-400"
                                                    : alert.type === "danger"
                                ...
                                {currentUser.insurance.claimsHistory.map((claim, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="text-right">
                                            ...
                                            <p
                                                className={`text-sm ${claim.status === "Settled" || claim.status === "Paid"
                                                    ? "text-green-600"
                                                    : "text-orange-600"
                                                    }`}
                                            >
                        ...
                        <div className="bg-white shadow-2xl rounded-2xl p-6">
                            ...
                            <div className="flex space-x-2 mb-6">
                                {[
                                    ...
                                    <button
                                        key={index}
                                        className={`px-3 py-1 rounded-lg text-xs font-medium transition-all duration-300 ${index === 0
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className="text-xs text-center space-y-1">
                                                        ...
                                                        <div
                                                            className={`text-xs ${data.current > data.previous
                                                                ? "text-red-500"
                                                                : "text-green-500"
                                                                }`}
                                                        >
                                    ...
                                    (item, index) => (
                                        <div key={index} className="space-y-3">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="text-right">
                                                    <div
                                                        className={`text-lg font-bold ${item.status === "above"
                                                            ? "text-green-600"
                                                            : "text-blue-600"
                                                            }`}
                                                    >
                                            ...
                                            <div className="w-full h-3 bg-gray-200 rounded-full">
                                                <div
                                                    className={`h-3 rounded-full transition-all duration-1000 ${item.status === "above"
                                                        ? "bg-green-500"
                                                        : "bg-blue-500"
                                                        }`}
                                            ...
                                            <div
                                                className={`text-sm ${item.status === "above"
                                                    ? "text-green-600"
                                                    : "text-blue-600"
                                                    }`}
                                            >
                                                {item.status === "above"
                                                    ...
                                                    : `You're in the top ${100 - item.percentile
                                                    }% for this metric`}
                                            </div>
                                        </div>
                                    )
                                            ...
                                            <div className="flex items-start space-x-3">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="flex items-center justify-between mt-3">
                                                        ...
                                                        <span
                                                            className={`text-xs px-2 py-1 rounded-full ${rec.difficulty === "Easy"
                                            ...
                                            <div className="flex items-start space-x-3">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="flex items-center justify-between mt-3">
                                                        ...
                                                        <span
                                                            className={`text-xs px-2 py-1 rounded-full ${rec.risk === "None"
                                                                ? "bg-green-100 text-green-700"
                                                                : rec.risk === "Low"
                            ...
                            <div className="space-y-4">
                                ...
                                {currentUser.comparison.recommendations.financialHealthTips.map(
                                    (rec, index) => (
                                        <div
                                            key={index}
                                            className={`p-4 border rounded-lg ${rec.status === "excellent"
                                        ...
                                        >
                                            <div className="flex items-start space-x-3">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="mt-3">
                                                        <span
                                                            className={`text-xs px-2 py-1 rounded-full ${rec.status === "excellent"
                                                                ? "bg-green-100 text-green-700"
                                                                : rec.status === "priority"
