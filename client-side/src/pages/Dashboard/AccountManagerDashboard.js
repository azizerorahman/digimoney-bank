...
import { 
  ...
  Activity, Zap, Globe, Award, BookOpen, Bell,ArrowUpDown,Eye,Flag,ArrowLeft
} from 'lucide-react';
...
const [newCustomerData, setNewCustomerData] = useState({
  ...
  const accountManagerData = {
    ...
    upcomingMeetings: [
      {
        ...
        agenda: ["Portfolio Performance", "Tax Strategy", "New Investment Opportunities"],
        status: "Confirmed"
      },
      {
        id: "MEET-002",
    ...
    revenueMetrics: {
      ...
      byCustomer: [
        ...
        { name: "Green Valley Restaurant Group", revenue: 18000, percentage: 14.4 },
  ...
  const getRiskColor = (risk) => {
    switch (risk) {
      ...
      case 'Moderate Aggressive': return 'text-orange-600 dark:text-orange-400';
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-blue-600 dark:text-blue-400">Emails Sent</p>
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-green-600 dark:text-green-400">Calls Made</p>
              ...
              <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-purple-600 dark:text-purple-400">Video Calls</p>
                    <p className="text-2xl font-bold text-purple-700 dark:text-purple-300">6</p>
                  </div>
              ...
              <div className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-orange-600 dark:text-orange-400">Meetings</p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
              <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-semibold text-black dark:text-white">Communication History</h3>
                  <button className="bg-blue-600 dark:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700 dark:hover:bg-blue-600">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  {accountManagerData.communicationHistory.map(comm => (
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex items-center space-x-3">
                          <div className={`p-2 rounded-full ${
                            ...
                            comm.type === 'Phone' ? 'bg-green-100 dark:bg-green-900/20' :
                            ...
                            {comm.type === 'Video Call' && <Video className="h-4 w-4 text-purple-600 dark:text-purple-400" />}
                          </div>
                          <div>
                            <p className="font-medium text-black dark:text-white">{comm.subject}</p>
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                              {comm.type} • {comm.direction} • 
                              {comm.customerId && ` Customer: ${comm.customerId}`}
                            </p>
                            {comm.duration && (
                              <p className="text-sm text-gray-500 dark:text-gray-400">Duration: {comm.duration}</p>
                            )}
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="text-sm text-gray-500 dark:text-gray-400">{comm.date}</p>
                          <p className="text-sm text-gray-500 dark:text-gray-400">{comm.time}</p>
                          <span className={`inline-block px-2 py-1 rounded-full text-xs mt-1 ${
                            comm.priority === 'High' ? 'bg-red-100 dark:bg-red-900/20 text-red-800 dark:text-red-400' :
                            'bg-gray-100 dark:bg-gray-800 text-black dark:text-white'
                          }`}>
                            {comm.priority}
                          </span>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <button className="flex items-center justify-center space-x-2 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 p-4 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30">
                  <Mail className="h-5 w-5" />
                  <span>Send Email</span>
                </button>
                <button className="flex items-center justify-center space-x-2 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 p-4 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30">
                  <Phone className="h-5 w-5" />
                  <span>Make Call</span>
                </button>
                <button className="flex items-center justify-center space-x-2 bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300 p-4 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30">
      ...
      {showCustomerDetails && selectedCustomer && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-black dark:text-white">{selectedCustomer.name}</h2>
              <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
              <div className="lg:col-span-2">
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  <h3 className="font-semibold text-black dark:text-white mb-3">Customer Information</h3>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-600 dark:text-gray-400">Customer ID:</span>
                      <p className="font-medium text-black dark:text-white">{selectedCustomer.customerId}</p>
                    </div>
                    <div>
                      <span className="text-gray-600 dark:text-gray-400">Customer Since:</span>
                      <p className="font-medium text-black dark:text-white">{selectedCustomer.since}</p>
                    </div>
                    <div>
                      <span className="text-gray-600 dark:text-gray-400">Relationship Type:</span>
                      <p className="font-medium text-black dark:text-white">{selectedCustomer.relationship}</p>
                    </div>
                    <div>
                      <span className="text-gray-600 dark:text-gray-400">Risk Profile:</span>
                      <p className={`font-medium ${getRiskColor(selectedCustomer.riskProfile)}`}>
              ...
              <div>
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  <h3 className="font-semibold text-black dark:text-white mb-3">Portfolio Summary</h3>
            ...
            {/* Accounts Details */}
            <div className="mb-6">
              <h3 className="font-semibold text-black dark:text-white mb-3">Account Details</h3>
              <div className="overflow-x-auto">
                <table className="w-full border border-gray-200 dark:border-gray-700 rounded-lg">
                  <thead className="bg-gray-50 dark:bg-gray-700">
                    <tr>
                      <th className="px-4 py-2 text-left text-sm font-medium text-gray-600 dark:text-gray-400">Account Type</th>
                      <th className="px-4 py-2 text-left text-sm font-medium text-gray-600 dark:text-gray-400">Account Number</th>
                      <th className="px-4 py-2 text-left text-sm font-medium text-gray-600 dark:text-gray-400">Balance</th>
                      <th className="px-4 py-2 text-left text-sm font-medium text-gray-600 dark:text-gray-400">Status</th>
                      <th className="px-4 py-2 text-left text-sm font-medium text-gray-600 dark:text-gray-400">Performance</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                    {selectedCustomer.accounts.map((account, idx) => (
                      <tr key={idx} className="bg-white dark:bg-gray-800">
                        <td className="px-4 py-2 text-sm text-black dark:text-white">{account.type}</td>
                        <td className="px-4 py-2 text-sm text-gray-600 dark:text-gray-400">{account.accountNumber}</td>
                        <td className={`px-4 py-2 text-sm font-medium ${
                          account.balance < 0 ? 'text-red-600 dark:text-red-400' : 'text-black dark:text-white'
                        }`}>
                        ...
                        <td className="px-4 py-2">
                          ...
                          <td className={`px-4 py-2 text-sm font-medium ${
                            account.performance > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'
                          }`}>
                ...
                <div className="space-y-3">
                  {selectedCustomer.recentActivity.map((activity, idx) => (
                    <div key={idx} className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <div className={`p-2 rounded-full ${
                        activity.type === 'Transaction' ? 'bg-blue-100 dark:bg-blue-900/20' :
                        activity.type === 'Communication' ? 'bg-green-100 dark:bg-green-900/20' :
                        'bg-purple-100 dark:bg-purple-900/20'
                      }`}>
                        {activity.type === 'Transaction' && <ArrowUpDown className="h-4 w-4 text-blue-600 dark:text-blue-400" />}
                        {activity.type === 'Communication' && <MessageSquare className="h-4 w-4 text-green-600 dark:text-green-400" />}
                        {activity.type === 'Meeting' && <Users className="h-4 w-4 text-purple-600 dark:text-purple-400" />}
                      </div>
                      <div className="flex-1">
                        <p className="text-sm font-medium text-black dark:text-white">{activity.description}</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">{activity.date} • {activity.time}</p>
                      </div>
                    </div>
                  ))}
                </div>
