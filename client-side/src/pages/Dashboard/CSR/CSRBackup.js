            ...
            <div className="flex items-center space-x-6">
              <div className="text-right">
                ...
                <div className="text-xs text-black dark:text-white">
                  ...
                  {csrDashboardData.csrInfo.shift}
                </div>
              </div>
            ...
            {showSearchResults && (
              <div className="absolute top-full left-0 right-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg mt-1 z-10">
                {searchResults.length > 0 ? (
                  ...
                  <div className="p-3 text-black dark:text-white text-center">
                    No customers found
                  </div>
                )}
              </div>
                        ...
                        >
                          ...
                          <div className="space-y-3">
                            {category.issues.map((issue, issueIndex) => (
                              <div
                                key={issueIndex}
                                className="border-l-4 border-blue-400 dark:border-blue-500 pl-4"
                              >
                                <div className="font-medium text-sm text-black dark:text-white mb-1">
                                  {issue.title}
                                </div>
                                <div className="text-sm text-black dark:text-white mb-2 italic">
                                  "{issue.script}"
                                </div>
                                <div className="text-xs text-black dark:text-white">
                    ...
                    <div className="space-y-2">
                      {csrDashboardData.supportResources.quickResponses.map(
                        (response, index) => (
                          <div
                            key={index}
                            className="flex justify-between items-center p-2 hover:bg-gray-50 dark:hover:bg-gray-600 rounded"
                          >
                            <div>
