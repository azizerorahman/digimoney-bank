...
const Features = () => {
  ...
  useEffect(() => {
    ...
    // Create observer with options for better mobile performance
    ...
    if (isVisible) {
      // Animate heading with improved easing
      setTimeout(() => {
      ...
      // Animate feature cards with optimized staggered delay
  ...
  return (
    <section
      ref={sectionRef}
      className="py-20 md:py-28 lg:py-32 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 relative overflow-hidden"
      aria-label="Features Section"
    >
      {/* Decorative background elements */}
      <div className="absolute top-0 left-0 w-32 h-32 bg-primary/5 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 right-0 w-64 h-64 bg-accent/5 rounded-full translate-x-1/3 translate-y-1/3"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          >
            ...
            Banking Features for <span className="text-accent">Modern</span>{" "}
            Life
          </h2>
          <p
            ref={descriptionRef}
          ...
          >
            DigiMoney Bank combines cutting-edge technology with personalized
            service to provide you with the tools you need to manage your
            finances effortlessly.
          </p>
        </div>

        {/* Features grid with improved responsiveness */}
        <div
          ref={featuresRef}
        ...
        >
          ...
          <div className="feature-card group p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800 dark:text-white/90">
                Personalized Banking
              </h3>
              <p className="text-gray-600 dark:text-white/70 mb-4">
                AI-powered insights tailored to your financial habits and goals,
                helping you make smarter decisions with your money.
              </p>
          ...
          <div className="feature-card group p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 dark:text-white/70 mb-4">
                Advanced biometric authentication, real-time fraud detection,
                and end-to-end encryption to keep your finances secure.
              </p>
          ...
          <div className="feature-card group p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 dark:text-white/70 mb-4">
                Automated investment portfolios with real-time market analysis
                and personalized recommendations for your financial goals.
              </p>
          ...
          <div className="feature-card group p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 dark:text-white/70 mb-4">
                Send and receive money instantly with zero fees between
                DigiMoney accounts, and competitive rates for international
                transfers.
              </p>
          ...
          <div className="feature-card group p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 dark:text-white/70 mb-4">
                Create unlimited virtual cards for online shopping with custom
                spending limits and one-click card freezing for added security.
              </p>
          ...
          <div className="feature-card group p-6 rounded-2xl bg-gradient-to-br from-indigo-900 to-primary text-white shadow-lg hover:shadow-xl transition-all duration-300 border border-indigo-800 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/80 mb-4">
                Get pre-approved for loans and credit cards in seconds with our
        ...
        <div className="mt-16 p-8 md:p-10 rounded-2xl bg-gradient-to-r from-primary/10 to-accent/10 dark:from-primary/20 dark:to-accent/20 border border-gray-100 dark:border-gray-700 text-center">
          ...
          <p className="text-gray-600 dark:text-white/70 mb-6 max-w-2xl mx-auto">
            ...
            financial experience with DigiMoney Bank.
          </p>
